...
fun MainScreen(
    ...
    val searchCatalog = remember {
        listOf(
            ...
            SearchIndexEntry("Base Planning Year, CPI Inflation & FIRE Assumptions", "Settings > FIRE & Assets", 4, 1, listOf("base year", "cpi", "inflation", "settings", "planning year", "macro", "fire assumptions")),
